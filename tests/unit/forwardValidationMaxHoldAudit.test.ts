/**
 * npx vitest run tests/unit/forwardValidationMaxHoldAudit.test.ts
 */
import { describe, expect, it } from 'vitest';
import { auditMaxHoldTrades } from '../../src/services/forwardValidation/forwardValidationMaxHoldAudit';
...
describe('forwardValidationMaxHoldAudit', () => {
  it('splits take_profit vs max_hold', () => {
    ...
    const report = auditMaxHoldTrades({ bundle });
    expect(report.reached.tradeCount + report.notReached.tradeCount).toBe(report.totalTrades);
  });
});
