/**
 * npx vitest run tests/unit/forwardValidationVixBandAudit.test.ts
 */
import { describe, expect, it } from 'vitest';
import { auditVixBands } from '../../src/services/forwardValidation/forwardValidationVixBandAudit';
...
describe('forwardValidationVixBandAudit', () => {
  it('returns 4 VIX bands', () => {
    ...
    const report = auditVixBands({ bundle });
