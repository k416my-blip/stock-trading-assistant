/**
 * npx vitest run tests/unit/forwardValidationVix25SpyEtfForwardReturnAudit.test.ts
 */
import { describe, expect, it } from 'vitest';
import { auditVix25SpyEtfForwardReturns } from '../../src/services/forwardValidation/forwardValidationVix25SpyEtfForwardReturnAudit';
...
describe('forwardValidationVix25SpyEtfForwardReturnAudit', () => {
  it('returns 4 ETF rows', () => {
    ...
    const report = auditVix25SpyEtfForwardReturns({ bundle });
    expect(report.byEtf).toHaveLength(4);
  });
});
