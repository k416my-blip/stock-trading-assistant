/**
 * npx vitest run tests/unit/forwardValidationVix25MacdDistAudit.test.ts
 */
import { describe, expect, it } from 'vitest';
import { auditVix25MacdDist } from '../../src/services/forwardValidation/forwardValidationVix25MacdDistAudit';
...
describe('forwardValidationVix25MacdDistAudit', () => {
  it('returns 3 MACD buckets for vix25 cohort', () => {
    ...
    const report = auditVix25MacdDist({ bundle });
