/**
 * npx vitest run tests/unit/forwardValidationDist52StandaloneAudit.test.ts
 */
import { describe, expect, it } from 'vitest';
import { auditDist52Standalone } from '../../src/services/forwardValidation/forwardValidationDist52StandaloneAudit';
...
describe('forwardValidationDist52StandaloneAudit', () => {
  it('returns six dist52 buckets', () => {
    ...
    const report = auditDist52Standalone({ bundle });
