...
export type BursaStockMaterialAnalysis = {
  ...
  /** Phase23.1 — Earnings Revision Cross Signal（optional） */
  earningsRevisionCrossSignal?: import('./bursaEarningsRevisionCrossSignal').BursaEarningsRevisionCrossSignalAnalysis | null;
