...
export const EFFECT_PRIORITY_BY_KIND: Record<RuntimeEffectKind, RuntimeEffectPriority> = {
  ...
  STABILITY_RECONNECT_GUARD: 'CRITICAL',
  STABILITY_HYDRATION_ENFORCE: 'HIGH',
  STABILITY_ASYNC_STARVATION_WARN: 'HIGH',
  STABILITY_MIUI_DIAGNOSTIC: 'HIGH',
  STABILITY_OBSERVE: 'NORMAL',
  RESUME_GLOBAL_GATE: 'CRITICAL',
  RESUME_WS_RESTORE_SEQUENCE: 'CRITICAL',
  RESUME_SERIALIZE_HYDRATION: 'HIGH',
  RESUME_ASYNC_BURST_CLAMP: 'HIGH',
  RESUME_DEFER_TELEMETRY: 'HIGH',
  RESUME_COORDINATOR_OBSERVE: 'NORMAL',
  KERNEL_GUARD_SYNC: 'CRITICAL',
  MEMORY_PRESSURE_CLEANUP: 'HIGH',
