...
| **Commit（HEAD）** | `9feca69` — docs: record commit hash in Play IT owner console checklist |
...
| 項目 | 値 |
|------|-----|
| **Push** | **success** — `f32e7a9..211901d` → `origin/cursor/top3-maxdd-capital-audit`（本体） · `211901d..9feca69`（hash 追記）
